    ...
    >
        ...
        <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
            <p class="text-sm/6 text-gray-900">
                <strong class="font-semibold">E-Posta Doğrulanmadı!</strong>
            </p>
            <router-link
                :to="{ name: 'profile' }"
...
email_verified.value = authStore.user.email_verified ?? false;
const showAlert = ref(true); // Uyarıyı gösterebilmek için yeni bir ref

const dismissAlert = () => {
    showAlert.value = false; // Uyarıyı gizle
};
</script>
